                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            <button
                                                ...
                                                className={`py-2.5 px-3 text-xs font-semibold rounded-xl border transition-all ${sendType === 'immediate'
                                            ...
                                            <button
                                                ...
                                                className={`py-2.5 px-3 text-xs font-semibold rounded-xl border transition-all ${sendType === 'scheduled'
                                                        ? 'bg-brand-600/30 text-white border-brand-500 shadow-[0_0_12px_rgba(99,102,241,0.2)]'
                                                        : 'bg-white/5 border-white/10 text-gray-400 hover:text-white hover:bg-white/10'
                                                    }`}
                                            >
